...
class _AlarmListScreenState extends State<AlarmListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ultimate Alarm Clock', style: TextStyle(color: Colors.white)),
                    ...
                    Padding(
                      ...
                      child: CircleAvatar(
                        ...
                        child: Text(
                          ['M', 'T', 'W', 'T', 'F', 'S', 'S'][i],
                          style: TextStyle(
                            color: alarm.days[i] ? Colors.white : Colors.white.withOpacity(0.5),
                            fontSize: 12,
                          ),
                        ),
                      ),
                  ...
                  GestureDetector(
                    ...
                    child: CircleAvatar(
                      ...
                      child: Text(
                        ['M', 'T', 'W', 'T', 'F', 'S', 'S'][i],
                        style: TextStyle(
                          color: _days[i] ? Colors.white : Colors.white.withOpacity(0.5),
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
